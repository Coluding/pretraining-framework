...
class DatasetUtils:
    ...
    def dataset_info_from_yaml(yaml_path: str) -> List[DatasetInfo]:
        ...
        :param yaml_path: Path to yaml file where dataset info is stored
    ...
    @staticmethod
    def get_dataset_info(dataset_infos_path: str,
                         dataset_name: str,
                         dataset_subset: str) -> DatasetInfo:
        """
        Return the DatasetInfo based on name and subset
        :param dataset_infos_path: Path to yaml file where dataset info is stored
        :param dataset_name: Name of the dataset
        :param dataset_subset: Subset of the dataset
        :return: DatasetInfo
        """
        _dataset_infos = DatasetUtils.dataset_info_from_yaml(yaml_path=dataset_infos_path)
        dataset_infos = []
